    ...
    <div className="min-h-screen bg-background flex">
        ...
        <div className="relative z-10 grid grid-cols-3 gap-4">
          {[
            ...
            <div key={stat.label} className="bg-white/10 backdrop-blur rounded-xl p-4 border border-white/20">
              <p className="text-white text-xl font-bold" style={{ fontFamily: "'Syne', sans-serif" }}>{stat.value}</p>
      ...
      <div className="w-full lg:w-1/2 flex items-center justify-center p-8">
        <div className="w-full max-w-md">
          ...
          <div className="mb-8">
            <h2 className="text-3xl font-bold text-foreground mb-2" style={{ fontFamily: "'Syne', sans-serif" }}>
              Welcome back
            </h2>
